...
async function seedTenantBurgers() {
  console.log(
    '🚀 Iniciando setup del tenant HAMBURGUESERÍA (Existente):',
    TARGET_TENANT_ID,
  );
  ...
  try {
    ...
    if (!existingMembership) {
      console.log(
        `🔗 Vinculando membresía ADMIN para el usuario ${TARGET_USER_ID}...`,
      );
    ...
    const catSides = await AppDataSource.getRepository(Category).save(
      AppDataSource.getRepository(Category).create({
        tenantId: tenant.id,
        name: 'Acompañamientos Crujientes',
        order: 3,
      }),
    );
    ...
    await AppDataSource.getRepository(Product).save(
      [
        {
          tenantId: tenant.id,
          categoryId: catSmashClasicas.id,
          order: 1,
          isFeatured: true,
          isActive: true,
          ...
          price: 680000,
          description:
            'Dos medallones smash de 90g con costra caramelizada, 4 fetas de cheddar, kétchup, mostaza y cebolla picadita.',
        },
        {
          tenantId: tenant.id,
          categoryId: catSmashClasicas.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Triple Cheeseburger Smash',
          price: 850000,
          description:
            'Tres medallones de carne vacuna premium aplastados finitos, 6 fetas de queso cheddar derretido.',
        },
        {
          tenantId: tenant.id,
          categoryId: catSmashClasicas.id,
          ...
          isFeatured: true,
          isActive: true,
          name: 'The Oklahoma Onion Single',
          price: 520000,
          description:
            'Medallón smash de 100g con cebolla en juliana cocinada e integrada en la plancha, cheddar y pepinillos.',
        },
        {
          tenantId: tenant.id,
          categoryId: catSmashEspeciales.id,
          order: 1,
          isFeatured: true,
          isActive: true,
          name: 'Sweet Chili & Crispy Bacon',
          price: 790000,
          description:
            'Doble smash, cheddar, panceta glaseada en sweet chili casero, crocante de cebolla deshidratada y aderezo alioli.',
        },
        {
          tenantId: tenant.id,
          categoryId: catSmashEspeciales.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Smoked Truffle Egg',
          price: 850000,
          description:
            'Doble smash premium, provola ahumada fundida, huevo a la plancha con yema blanda y emulsión de trufa.',
        },
        {
          tenantId: tenant.id,
          ...
          isFeatured: true,
          isActive: true,
          name: 'Papas Crinkle con Cheddar y Verdeo',
          price: 390000,
          description:
            'Papas con corte rejilla súper crocantes, crema de queso cheddar templado y cebollita de verdeo.',
        },
        {
          tenantId: tenant.id,
          categoryId: catSides.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Bastones de Mozzarella XXL (x5)',
          price: 450000,
          description:
            'Cuerpo de mozzarella hilada gigante, súper crocantes por fuera y súper elásticos por dentro.',
        },
        {
          tenantId: tenant.id,
          ...
          isFeatured: true,
          isActive: true,
          name: 'Super Oreo & Cream Shake',
          price: 350000,
          description:
            'Licuado súper espeso de helado de crema americana, dulce de leche natural y galletitas Oreo troceadas.',
        },
        {
          tenantId: tenant.id,
        ...
        },
        {
          ...
          isFeatured: true,
          isActive: true,
          name: 'Limonada Casera con Menta y Jengibre',
          price: 250000,
          description:
            'Exprimido natural de limones del día, hojas de menta fresca y un toque de jengibre.',
        },
        {
          tenantId: tenant.id,
          categoryId: catBebidas.id,
          ...
          isFeatured: true,
          isActive: true,
          name: 'Cerveza IPA Artesanal Lata 473ml',
          price: 320000,
          description:
            'Birra artesanal bien fría de lupulado intenso y notas cítricas.',
        },
        {
          tenantId: tenant.id,
          categoryId: catBebidas.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Cerveza Golden Artesanal Lata 473ml',
          price: 300000,
          description:
            'Birra artesanal dorada, suave, ligera y sumamente refrescante.',
        },
        {
          tenantId: tenant.id,
          categoryId: catBebidas.id,
