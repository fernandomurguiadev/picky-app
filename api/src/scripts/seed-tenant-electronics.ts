...
async function seedTenantElectronics() {
  console.log(
    '🚀 Iniciando setup del nuevo tenant de ELECTRÓNICA & GADGETS...',
  );
    ...
    await AppDataSource.getRepository(Product).save(
      [
        // Celulares y Tablets
        {
          ...
          isFeatured: true,
          isActive: true,
          name: 'Smartphone Pro 256GB Platinum',
          price: 125000000,
          description:
            'Pantalla AMOLED de 120Hz, triple cámara de 50MP, procesador de 4nm con IA integrada.',
        },
        {
          tenantId: tenant.id,
          categoryId: catSmartphones.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Tablet Creator 11" Wifi',
          price: 68900000,
          description:
            'Pantalla de 11 pulgadas ultra fluida, 128GB de almacenamiento y soporte para stylus activo.',
        },
        {
          tenantId: tenant.id,
          categoryId: catSmartphones.id,
          ...
          price: 4500000,
          description:
            'Carga rápida compacta con tecnología de nitruro de galio. Tres puertos inteligentes.',
        },
        // Audio
        {
          tenantId: tenant.id,
          ...
          isFeatured: true,
          isActive: true,
          name: 'Auriculares Over-Ear ANC Studio',
          price: 34990000,
          description:
            'Cancelación activa de ruido inteligente, audio espacial adaptativo y 40 horas de reproducción.',
        },
        {
          tenantId: tenant.id,
          categoryId: catAudio.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Parlante Bluetooth WaterProof 30W',
          price: 21500000,
          description:
            'Resistente al agua y al polvo IP67, doble radiador pasivo y hasta 15 horas de batería.',
        },
        // Computadoras
        {
          tenantId: tenant.id,
          ...
          price: 189000000,
          description:
            'Procesador de última generación, 16GB RAM LPDDR5, 512GB SSD NVMe. Chasis de aluminio aeroespacial.',
        },
        {
          tenantId: tenant.id,
          categoryId: catComputing.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Monitor Oficina Curvo 27"',
          price: 54900000,
          description:
            'Resolución QHD (2560x1440) de 75Hz con protección ocular frente a luz azul.',
        },
        // Gaming
        {
          tenantId: tenant.id,
          ...
          isFeatured: true,
          isActive: true,
          name: 'Consola Next-Gen 1TB SSD',
          price: 215000000,
          description:
            'Juegos a 4K nativo y 120 FPS. Incluye un joystick inalámbrico de precisión.',
        },
        {
          tenantId: tenant.id,
          categoryId: catGaming.id,
          ...
          isFeatured: false,
          isActive: true,
          name: 'Joystick Inalámbrico Chameleon',
          price: 24500000,
          description:
            'Gatillos dinámicos de resistencia variable y retroalimentación háptica inmersiva.',
        },
        // Smart Home
        {
          tenantId: tenant.id,
          ...
          price: 13900000,
          description:
            'Grabación en resolución 2K, visión nocturna infrarroja y detección inteligente de movimiento.',
        },
