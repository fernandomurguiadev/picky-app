...
export class InitialSchema1778711637762 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('pending', 'confirmed', 'preparing', 'ready', 'delivered', 'cancelled')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_deliverymethod_enum" AS ENUM('delivery', 'takeaway', 'in_store')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_paymentmethod_enum" AS ENUM('cash', 'transfer', 'card', 'other')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_c2cfc2bf7cb89228185e15644c" ON "orders" ("tenantId", "createdAt") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_2320894752c92ce150ff491241" ON "orders" ("tenantId", "status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_04134efffeb3c7e14ab91d44cf" ON "store_settings" ("tenantId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_59b20a0e533a340fb6016cba5f" ON "categories" ("tenantId", "order") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tenant_memberships_role_enum" AS ENUM('admin', 'staff')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_eb04bbaf99aae176af0ff8a7fc" ON "tenant_memberships" ("userId", "tenantId") `,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_208a358e9fe8abe6e1d82459804" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "store_settings" ADD CONSTRAINT "FK_04134efffeb3c7e14ab91d44cfc" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "categories" ADD CONSTRAINT "FK_46a85229c9953b2b94f768190b2" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" ADD CONSTRAINT "FK_6804855ba1a19523ea57e0769b4" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "option_groups" ADD CONSTRAINT "FK_76755498d6a8232e737ca1136c6" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "option_items" ADD CONSTRAINT "FK_4cb7c5e59e2ed20ec4be9756a46" FOREIGN KEY ("optionGroupId") REFERENCES "option_groups"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tenant_memberships" ADD CONSTRAINT "FK_f2a716ce4ea37745564baaccda3" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "option_items" DROP CONSTRAINT "FK_4cb7c5e59e2ed20ec4be9756a46"`,
    );
    await queryRunner.query(
      `ALTER TABLE "option_groups" DROP CONSTRAINT "FK_76755498d6a8232e737ca1136c6"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "store_settings" DROP CONSTRAINT "FK_04134efffeb3c7e14ab91d44cfc"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_eb04bbaf99aae176af0ff8a7fc"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_60641843a69bd415aa8840e30f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4dd1b85bcfc67fc32d5fd96b71"`,
    );
    await queryRunner.query(`DROP TABLE "products"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_59b20a0e533a340fb6016cba5f"`,
    );
    await queryRunner.query(`DROP TABLE "categories"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_04134efffeb3c7e14ab91d44cf"`,
    );
    await queryRunner.query(`DROP TABLE "store_settings"`);
    await queryRunner.query(`DROP TABLE "order_items"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2320894752c92ce150ff491241"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c2cfc2bf7cb89228185e15644c"`,
    );
